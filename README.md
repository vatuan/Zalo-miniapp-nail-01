...
## How to use AI_RULES.md and AI_SKILLS.md in every future prompt

Use this instruction block at the beginning of every AI coding prompt:

```text
Read and strictly follow:
1) /Users/mac/Documents/tuanva/freelancer/zalo-miniapp-nail-02/AI_RULES.md
2) /Users/mac/Documents/tuanva/freelancer/zalo-miniapp-nail-02/AI_SKILLS.md

Before coding:
- summarize the architecture constraints you will follow
- confirm which folder(s) you will touch

While coding:
- keep shared layer free of feature logic
- use mock-first approach
- apply route/store/page conventions from AI_RULES

After coding:
- report changed files
- explain how your changes comply with AI_RULES and AI_SKILLS
```

Recommended prompt pattern:

```text
Act as a Senior Frontend Architect in this Zalo Mini App repo.
Follow AI_RULES.md and AI_SKILLS.md strictly.
Task: <your task>
